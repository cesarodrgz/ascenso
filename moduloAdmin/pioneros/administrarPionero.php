...
$consulta = mysqli_query($enlace, "SELECT * from usuarios WHERE departamento = 'pioneros'");
//Iniamos la sesión
session_start();
...
<head>
    <title>Administrar Usuarios - pioneros</title>
    <!-- icono -->
...
<!--NavBar-->
<?php include '../../templates/pioneros/nav1.php' ?>

<body>
    <br>
    <div class="text-center">
        <!-- Logo de navegantes-->
        <img src="../../img/pioneros.png" alt="LOGO-pioneros" style="width: 100px;">
    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    ...
                                    <input type="hidden" name="departamento" id="" value="pioneros" readonly>
                ...
                <tbody>
                    ...
                    while ($datos = mysqli_fetch_array($consulta)) { ?>
                        <tr>
                            ...
                            <td>
                                <form action="actualizarPionero.php" method="post">
