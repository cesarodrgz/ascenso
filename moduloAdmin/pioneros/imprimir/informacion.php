...
<head>
    <title>Informacion personal pioneros</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<!--Navbar-->
<?php include '../../../templates/pioneros/nav7.php' ?>

<body>
    <div class="text-center">
        <!-- Logo de navegantes-->
        <img src="../../../img/pioneros.png" alt="logo-pioneros" class="rounded" style="width: 100px;">
    </div>
