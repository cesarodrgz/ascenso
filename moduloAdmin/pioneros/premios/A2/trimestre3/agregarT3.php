...
<body>
                ...
                <form action="" method="post">
                    ...
                    <?php foreach ($consulta as $info) : ?>
                        ...
                        <select name="p5" class="form-control">
                            ...
                            <option value="Brújula">Brújula</option>
                        </select> <br>
    ...
    */
    if (isset($_POST["send"])) {
        ...
        //Insertamos los valores de id, user, nombre, y premios
        $insertar = "UPDATE piplata SET p5 = '$p5', p6 = '$p6' WHERE id = '$id' AND nombre = '$nombre'";
