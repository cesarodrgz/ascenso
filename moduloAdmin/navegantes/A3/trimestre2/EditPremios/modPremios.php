...
<body>
            ...
            <div class="col-xs-12 col-md-12 col-xl-12">
                <form action="" method="post">
                    ...
                    <select name="p5" id="" class="form-control">
                        ...
                        <option value="Ser un amigo">Ser un amigo</option>
                        <option value="Dios está trabajando">Dios está trabajando</option>
                        <option value="En el aire">En el aire</option>
    ...
    if (isset($_POST["send"])) {
        ...
        $actualizar = "UPDATE navoro SET p5 = '$p5', p6 = '$p6', p7 = '$p7', p8 = '$p8' WHERE id = '$id' AND nombre = '$nombre'";
