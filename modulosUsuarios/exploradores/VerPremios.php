...
$consulta = mysqli_query($enlace, "SELECT * from explobronce WHERE user = '$user'"); //Realizamos una búsqueda SQL en la tabla usuarios donde el usuario sea igual a lo que traiga la variable de incio de sesión
$consulta2 = mysqli_query($enlace, "SELECT * from exploplata WHERE user = '$user'"); //Realizamos una búsqueda SQL en la tabla usuarios donde el usuario sea igual a lo que traiga la variable de incio de sesión
?>
<!doctype html>
<html lang="en">
