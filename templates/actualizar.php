    ...
    switch ($accion) {
        ...
        case 'btnModificar':
            ...
            if ($tmpFoto != "") {
                ...
                move_uploaded_file($tmpFoto, "../../moduloAdmin/navegantes/img/" . $nombreArchivo);
                ...
                if (isset($busqueda['foto'])) {
                    if (file_exists("../../moduloAdmin/navegantes/img/" . $busqueda["foto"])) {
                        if ($busqueda['foto'] != "imagen.png") {
                            unlink("../../moduloAdmin/navegantes/img/" . $busqueda["foto"]);
                        }
                    }
                }
