...
<body>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-xl-12">
                <form action="" method="post">
                    ...
                    <p>Premio 4 - Trimestre 4
                        <small>(premio de liderazgo 1)</small>
                    </p>
                    ...
                    <p>Premio 5 - Trimestre 4
                        <small>(premio de liderazgo 4)</small>
                    </p>
    ...
    if (isset($_POST["send"])) {
        ...
        $p10 = $_POST["p10"];
        $p11 = $_POST["p11"];
        $actualizar = "UPDATE pioro SET p7 = '$p7', p8 = '$p8', p9 = '$p9', p10 = '$p10', p11 = '$p11' WHERE id = '$id'";
