...
<body>
    ...
    switch ($accion) {
            ////////////Cuando el caso sea de agregar EXPLORADOR//////////////////
        case 'btnAgregar':
    ...
    ?>
        ...
        case 'btnAgregarL':
            ...
            //Prepara la sentencia SQL que se utilizará para agregar la información de los usuarios
            //No agregamos el ID porque este la BBDD lo genera automaticamente
            $sentencia = $pdo->prepare("INSERT INTO usuarios (user, pass, foto, nombre, fechaNac, departamento) 
            VALUES (:user, :pass, :foto, :nombre, :fechaNac, :departamento)");
