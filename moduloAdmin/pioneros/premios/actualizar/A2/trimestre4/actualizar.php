...
<body>
            ...
            <div class="col-xs-12 col-md-12 col-xl-12">
                <form action="" method="post">
                    ...
                    <select name="p7" id="" class="form-control">
                        ...
                        <option value="Estudio de las aves">Estudio de las aves</option>
                        <option value="Ninguno">Ninguno</option>
                    </select> <br>

                    <p>Premio 2 - Trimestre 4
                        <small>(premio bíblico)</small>
                    </p>
                    ...
                    <p>Premio 3 - Trimestre 4
                        <small>(premio de destreza requerido)</small>
                    </p>
                    ...
                    <p>Premio 3 - Trimestre 4
                        <small>(premio de liderazgo)</small>
                    </p>
                    <select name="p10" id="" class="form-control">
                        <option value="<?php echo $premio9 ?>"> Premio actual asignado: <?php echo  $premio10 ?> </option>
    ...
    if (isset($_POST["send"])) {
        ...
        $p9 = $_POST["p9"];
        $p10 = $_POST["p10"];
        $actualizar = "UPDATE piplata SET p7 = '$p7', p8 = '$p8', p9 = '$p9', p10 = '$p10' WHERE id = '$id'";
