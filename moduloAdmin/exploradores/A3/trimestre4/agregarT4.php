...
<head>
    <title>Agregar Trimestre 4 | A3 - Admin</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
        <!--Encabezado-->
        <h1 class="text-primary text-center">Seleccionar premios - Trimestre 4 | A3</h1>
        <div class="row">
                ...
                <form action="" method="post">
                    ...
                    <?php foreach ($consulta as $info) : ?>
                        ...
                        <select name="p5" class="form-control">
                            <option value="Ninguno">Ninguno</option>
                            <option value="Premio de liderazgo 302">Premio de liderazgo 303</option>
                        </select> <br>
    ...
    */
    if (isset($_POST["send"])) {
        ...
        $actualizar = "UPDATE explooro SET p4 = '$p4', p5 = '$p5'
