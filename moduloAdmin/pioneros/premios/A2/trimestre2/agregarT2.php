...
<body>
                ...
                <form action="" method="post">
                    ...
                    <?php foreach ($consulta as $info) : ?>
                        ...
                        <select name="p3" class="form-control">
                            ...
                            <option value="Estudios de los insectos">Estudios de los insectos</option>
                        </select> <br>
    ...
    */
    if (isset($_POST["send"])) {
        ...
        $insertar = "UPDATE piplata SET p3 = '$p3', p4 = '$p4' WHERE id = '$id' AND nombre = '$nombre'";
    ...
    ?>
        ...
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p5pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
</body>
