...
<head>
    <title>Actualizar pioneros - Administrador</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body> <br>
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-12 col-xl-12">
                <h2 class="text-center">
                    Editar Perfil Pionero <br> (Administrador)
                </h2>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-12 col-xl-12">
            <?php
            //Realizamos una búsqueda SQL en la tabla usuarios donde mostramos a todos los usuarios del departamento de pioneross
