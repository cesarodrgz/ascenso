...
<head>
    <title>Administrar Usuarios - Seguidores</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-row">
                                    ...
                                    <input type="hidden" name="departamento" id="" value="Seguidores" readonly>
                ...
                <tbody>
                    ...
                    while ($datos = mysqli_fetch_array($consulta)) { ?>
                        <tr>
                            ...
                            <td>
                                <form action="actualizarSeguidor.php" method="post">
