...
<body>
            ...
            <div class="col-xs-12 col-md-12 col-xl-12">
                <form action="" method="post">
                    ...
                    <select name="p3" id="" class="form-control">
                        ...
                        <option value="Estudio de los insectos">Estudio de los insectos</option>
                        <option value="Ninguno">Ninguno</option>
                    </select> <br>

                    <p>Premio 2 - Trimestre 2
    ...
    if (isset($_POST["send"])) {
        ...
        $p3 = $_POST["p3"];
        $p4 = $_POST["p4"];
        $actualizar = "UPDATE piplata SET p3 = '$p3', p4 = '$p4' WHERE id = '$id'";
