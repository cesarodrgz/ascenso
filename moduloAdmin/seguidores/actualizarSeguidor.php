...
<head>
    <title>Actualizar Seguidores - Administrador</title>
    <!-- Icono -->
...
<body> <br>
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-12 col-xl-12">
                <h2 class="text-center">
                    Editar Perfil Seguidor <br> (Administrador)
                </h2>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-12 col-xl-12">
            <?php
            //Realizamos una búsqueda SQL en la tabla usuarios donde mostramos a todos los usuarios del departamento de Seguidoress
