...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-xl-12">
                <img src="../../../img/2.png" class="mx-auto d-block" alt="T2/Q2" style="width: 125px;">
                <br>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-xl-12">
                <img src="../../../img/3.png" class="mx-auto d-block" alt="T3/Q3" style="width: 125px;">
                <br>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-xl-12">
                <img src="../../../img/4.png" class="mx-auto d-block" alt="T4/Q4" style="width: 125px;">
                <br>
